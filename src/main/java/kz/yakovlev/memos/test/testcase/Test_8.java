...
/**
 * Краткое описание:
 * Создание и отображение записи с большим текстом в названии.
 *
 * Шаги:
 * 1. Запустить браузер и перейти по ссылке ﻿http://localhost:8080/#!/login
 ...
 4. Заполнить поле ﻿Memo title данными - ﻿
    
    ...
    ArhivedTitleArhivedTitleArhivedTitleArhivedTitleArhivedTitle
    ArhivedTitleArhivedTitleArhivedTitleArhivedTitleArhivedTitle,
    заполнить поле Description данными - ArhivedDescription,
 ...
 */
public class Test_8 {
    private final String title="";
    private final String description="ArhivedDescription";
